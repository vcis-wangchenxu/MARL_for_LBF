...
def visualize_benchmark(results_dir, env_name):
    """
    加载 results_dir 下所有算法的 .pkl 文件并绘图。
    文件名格式要求: {algo_name}_train_data.pkl 或 {algo_name}_eval_data.pkl
    """
    ...
    if train_files:
        ...
        for f in train_files:
            # 从文件名提取算法名称: "results/IDQN_train_data.pkl" -> "IDQN"
